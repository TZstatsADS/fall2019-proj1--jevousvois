...
```{r}
# load lyrics data
load('C:/Users/AshChiVoo/Documents/GitHub/fall2019-proj1--jevousvois/data/lyrics.RData') 
```
...
```{r export data}
save(dt_lyrics, file="C:/Users/AshChiVoo/Documents/GitHub/fall2019-proj1--jevousvois/outputprocessed_lyrics.RData")
```
